...
CREATE TABLE `quotations` (
  ...
  `client_id` int(11) DEFAULT NULL,
  `manual_client_name` varchar(255) DEFAULT NULL,
  `manual_client_email` varchar(255) DEFAULT NULL,
  `manual_client_phone` varchar(100) DEFAULT NULL,
  `manual_client_business` varchar(255) DEFAULT NULL,
